        ...
        <Modal isOpen={isOpenModal} onClose={closeModal}>
              ...
              <div className='flex flex-col justify-center items-center'>
                ...
                <div className='flex flex-row flex-wrap items-center justify-evenly mb-8'>
                  ...
                  <textarea value={obb} onChange={(e) => setObb(e.target.value)} className='mb-4 w-64 h-32 rounded p-2 focus:outline-none placeholder-gray-500 bg-stone-100' placeholder='Observações'></textarea>
                  <Calendar className='mb-8 rounded-lg' onChange={handleDateChange} value={date}></Calendar>
                  <input value={valor} onChange={(e)=>setValor(e.target.value)} className='p-2 mb-5 border-none focus:outline-none placeholder-gray-500 bg-stone-100' type='number' placeholder='Valor'></input>
                  <input id='recorrencia' type='checkbox'></input>
                  <label for="recorrencia">Recorrente</label><br></br>
